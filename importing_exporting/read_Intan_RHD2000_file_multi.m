function [amplifier_channels, amplifier_data, aux_input_channels, aux_input_data, board_dig_in_channels, board_dig_in_data, board_adc_channels, board_adc_data, frequency_parameters, t_amplifier, t_aux_input, t_dig, t_board_adc] = read_Intan_RHD2000_file_multi(file, path, file_n)
...
if (data_present)
    ...
    fprintf(1, 'Reading data from file %d...\n', file_n);
