...
function [accuracyResponses] = l_svmClassifyAllTrials(esp, odors, option)
...
repetitions = 1000;
[mean_acc_svm, std_acc_svm, acc_svm, prctile25, prctile75, conMat] = odor_c_svm_1leaveout_reduced(dataAll, trainingN, labels, repetitions);
