...
%
%  - svm.multiclass_classification_scheme (default value is 'all_pairs').  This field can
...
%==========================================================================    
  ...
  properties 
        ...
        multiclass_classification_scheme = 'all_pairs';   % options are 'one_vs_all' or 'all_pairs'.
  end
  ...
  properties (GetAccess = 'public', SetAccess = 'private')
    ...
    methods 
        ...
        function cl = train(cl, XTr, YTr)  
            ...
            if strcmp(cl.multiclass_classification_scheme, 'all_pairs')
            ...
            elseif strcmp(cl.multiclass_classification_scheme, 'one_vs_all')
