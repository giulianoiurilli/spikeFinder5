fileToSave1 = 'pcx_mix_2_1.mat';
fileToSave2 = 'pcx_mix_2_3.mat';
load('parameters.mat');
startingFolder = pwd;
...
cd(startingFolder)
clearvars -except List espe1 esperimento1 fileToSave1 fileToSave2
espe = espe1;
esperimento = esperimento1;
clearvars -except List espe esperimento fileToSave1 fileToSave2
