function progress_bar(progressFraction, updateEvery, infoString)
%  by Hill DN, Mehta SB, & Kleinfeld D  - 07/12/2010
%
% progress_bar - improved progress indicator
%
% Usage:
%      progressBar(progressFraction, updateEvery, infoString)
%
% Description: 
...
% if current progress >= 1, delete the progress bar
...
% elseif the bar doest no exist, build it
