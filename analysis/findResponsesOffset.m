...
%                     
                ...
                esp(idxExp).shankNowarp(idxShank).cell(idxUnit).odor(idxO).goodExcTrialsOffset  = sum(goodTrialsExc)./n_trials;
                esp(idxExp).shankNowarp(idxShank).cell(idxUnit).odor(idxO).goodInhTrialsOffset  = sum(goodTrialsInh)./n_trials;
            end
        end
    end
end
