function [mean_acc_svm, std_acc_svm, acc_svm, prctile25, prctile75] = odor_c_svm_3leaveout(data, trainingN, labels, repN)


% classification for increasing number of  cells pre-sorted by odor
% discriminability
