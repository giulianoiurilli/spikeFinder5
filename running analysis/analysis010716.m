...
for idxEntry = 1:size(logExc,1)
    ...
    [respCellOdorPairPSTHExcMn(idxEntry,:), respCellOdorPairPSTHExcSd(idxEntry,:), respCellOdorPairPSTHExcCv(idxEntry,:)] = slidePSTH(snipCellOdorSniff, 50, 5);
end
...
%%
save('responsesPcx.mat', 'respCellOdorPairPSTHExcMn', 'respCellOdorPairPSTHExcSd', 'respCellOdorPairPSTHExcCv', 'distSniff', '-append')
