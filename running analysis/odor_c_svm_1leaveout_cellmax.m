function [mean_acc_svm, std_acc_svm, acc_svm, prctile25, prctile75, CM] = odor_c_svm_1leaveout_cellmax(data, trainingN, labels, repN, cellMax)
...
%     
    ...
    for rep = 1:repN
        ...
        for units = cellMax %2:150%10:10:150%2:size(data,2) %150 %size(data,2) %
            j                       = j + 1;
