...
grid on
ylabel('Change of correlation distasce between odor representations relative to rest', 'FontName', 'DIscondensed', 'FontSize', 14)
xlabel('respiration cycle', 'FontName', 'DIscondensed', 'FontSize', 14)
title('15 odors - odor dilution: 1/100', 'FontName', 'DIscondensed', 'FontSize', 14)
set(gcf,'color','white', 'PaperPositionMode', 'auto');
...
ylabel('Change of correlation distasce between odor representations relative to rest', 'FontName', 'DIscondensed', 'FontSize', 14)
xlabel('respiration cycle', 'FontName', 'DIscondensed', 'FontSize', 14)
title('Innately Relevant Odors - odor dilution: 1/100', 'FontName', 'DIscondensed', 'FontSize', 14)
set(gcf,'color','white', 'PaperPositionMode', 'auto');
