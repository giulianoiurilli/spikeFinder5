/* sample_mvgm.c
 ...
 mex -DranKISS -f mexopts_intel10.bat sample_mvgm.c
 
 or
 
 mex -DranSHR3 -f mexopts_intel10.bat sample_mvgm.c
...
void sample_mvgm(double * , double * , double * , int , int , int , int , int ,double * , double * ,double * , double * , double *);
...
void mexFunction( int nlhs, mxArray *plhs[],int nrhs, const mxArray *prhs[] )
{
    ...
    index          = mxGetPr(plhs[1]);
     ...
     /* vecteur temporaire */
    choles         = (double *)malloc((d*d*M*K)*sizeof(double));   
...
/* ------------------------------------------------------------------------------------------------- */
/* ------------------------------------------------------------------------------------------------- */
void sample_mvgm(double *mu , double *sigma , double *p , int d , int M , int N , int K , int V , double *Z , double *index , double *choles , double *v , double *b)
{
