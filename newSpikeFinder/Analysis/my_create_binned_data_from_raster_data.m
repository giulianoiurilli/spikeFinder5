function saved_binned_data_file_name = my_create_binned_data_from_raster_data(dataAll, raster_file_directory_name, save_prefix_name, bin_width, sampling_interval, start_time, end_time)
...
for i = 1:neurons
    A = [];
    for idxOdor = 1:stimuli
        for idxTrial = 1:trials
            A = [A; dataAll(i, idxTrial, idxOdor)'];
        end
    end
    binned_data{i} = A;
