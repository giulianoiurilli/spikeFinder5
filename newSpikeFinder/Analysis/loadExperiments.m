...
pcxAA_3 = load('aPCx_AAmix_3.mat');
pcx15_3 = load('aPCx_15_3.mat');
coa15_3 = load('plCoA_15_3.mat');
coaAA_3 = load('plCoA_AAmix_3.mat');
pcxNM_3 = load('aPCx_natMix_3.mat');
coaNM_3 = load('plCoA_natMix_3.mat');
coaCS1_3 = load('plCoA_CS1_3.mat');
coaCS2_3 = load('plCoA_CS2_3.mat');
pcxCS2_3 = load('aPCx_CS2_3.mat');
pcxCS1_3 = load('aPCx_CS1_3.mat');