function [meanAccuracy, stdevAccuracy, confMat] = findClassificationAccuracy(esp, nOdors, folder, option)

[totalSUA, totalResponsiveSUA, totalResponsiveNeuronPerOdor] = findNumberOfSua(esp, 1:nOdors);
